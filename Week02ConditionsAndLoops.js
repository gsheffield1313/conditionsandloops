...
if(mySpeed > speedLimit){
   console.log('Slow down my boy you got a little too mich dip on your chip')
 ...
 * 
 * ↓ YOUR CODE HERE ↓ */
//let i=0//start condition//
//stop condition if i =-10//
//i-- i ncrementor
...
//modify the previous do/while loop. print the iterator if the remaind (%//modulus) is 0 when divisible by 4.//
...
//start  i =11  //stop i >10  //incrementor i++//
  for (let i = 0; i < 10; i++) { 
      console.log(i);   
  }
